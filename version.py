...
def get_version_string() -> str:
    ...
    Returns:
        String like "MeXuS v1.0.0-alpha (Build 42)"
    """
    info = get_version_info()
    return f"MeXuS v{info['version']} (Build {info['build_number']})"
...
def get_version_with_date() -> str:
    ...
    Returns:
        String like "MeXuS v1.0.0-alpha (Build 42 - 2026-01-04 22:30)"
    """
    info = get_version_info()
    return f"MeXuS v{info['version']} (Build {info['build_number']} - {info['build_date']} {info['build_time']})"
