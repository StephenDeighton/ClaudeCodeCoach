"""
Platform-specific utilities for MeXuS
...
def get_app_data_dir() -> Path:
    ...
    if platform.system() == "Darwin":
        return Path.home() / "Library" / "Application Support" / "MeXuS"
    elif platform.system() == "Windows":
        return Path(os.environ.get("APPDATA", "")) / "MeXuS"
    else:
        return Path.home() / ".mexus"
...
def is_packaged_app() -> bool:
    ...
    if platform.system() == "Darwin":
        ...
        # e.g., .../MeXuS.app/Contents/MacOS/MeXuS
...
def get_default_db_path() -> Path:
    ...
    try:
        ...
        if is_packaged_app():
            ...
            return get_app_data_dir() / "mexus.db"
        else:
            # Development mode - use project directory
            return Path(__file__).parent.parent / "mexus.db"
